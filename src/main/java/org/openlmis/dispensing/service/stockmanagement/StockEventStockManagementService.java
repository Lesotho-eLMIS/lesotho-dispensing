...
import static org.openlmis.dispensing.util.RequestHelper.createUri;

import com.fasterxml.jackson.databind.ObjectMapper;
import java.io.IOException;
import java.util.UUID;
import org.openlmis.dispensing.dto.LocalizedMessageDto;
import org.openlmis.dispensing.dto.stockmanagement.StockEventDto;
import org.openlmis.dispensing.exception.ExternalApiException;
import org.openlmis.dispensing.exception.ServerException;
import org.openlmis.dispensing.i18n.MessageKeys;
import org.openlmis.dispensing.util.RequestHelper;
...
public class StockEventStockManagementService
  ...
  public void submit(StockEventDto stockEventDto) {
    ...
    try {
      runWithRetryAndTokenRetry(() -> restTemplate.exchange(
          createUri(url),
          HttpMethod.POST,
      ...
      if (ex.getStatusCode() == HttpStatus.BAD_REQUEST) {
        try {
          LocalizedMessageDto localizedMessage = objectMapper.readValue(ex.getResponseBodyAsString(),
              LocalizedMessageDto.class);
