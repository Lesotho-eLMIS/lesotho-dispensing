...
package org.openlmis.dispensing.domain.qualitychecks;
...
@NoArgsConstructor
@AllArgsConstructor
@Table(name = "dispensing_event_discrepencies", schema = "dispensing")
public class Discrepancy extends BaseEntity {
  ...
  // Many-to-one relationship with DispensingEvent
  @ManyToOne
  @JoinColumn(name = "dispensing_event_id")
  private DispensingEvent pointOfDeliveryEvent;
